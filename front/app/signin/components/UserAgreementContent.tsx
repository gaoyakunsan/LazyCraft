...
const UserAgreementContent = forwardRef<HTMLDivElement, UserAgreementContentProps>(
  ({ onScroll }, ref) => (
    <div
      ref={ref}
      style={{
    ...
    >
      ...
      <p style={{ marginBottom: '12px' }}>
        本平台是一个强大的大模型智能共生平台，提供模型训练、推理服务、数据管理等一站式解决方案。本协议是您与平台之间的法律协议，请仔细阅读。
      </p>
...
UserAgreementContent.displayName = 'UserAgreementContent'
